...
import { createAward, deleteAward, updateAward, uploadAwardImage } from "./actions";
...

      {
        ...
        populate: {
          ...
          Value: {
            ...
            populate: { currency: { fields: ["documentId", "name", "title"] } },
...
export default async function AwardsPage() {
  ...
  const [awards, currencies] = await Promise.all([loadAwards(), loadCurrencies()]);
